...
/*Class represents basic moves with basic moves training for superHeros
* Part of MVP(USer STory 2)*/
public class BasicTraining extends AbstractTraining {

    private static Scanner scanner = new Scanner( System.in );


// COnstructor that sets the basic training level
    public BasicTraining() {
        setTrainingId(GameConstants.TRAINING_ID);
        this.moves = PowerMovesRepository.getInstance().getBasicTrainingMoveList();
    }
    ...
    public boolean getTrained(Player player) {
        ...
        System.out.println("So in this training you will be mastering few of the listed moves!Here we go"+ CommandLineColors.ANSI_GREEN);
        printMoveList(moves);
